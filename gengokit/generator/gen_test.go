...
import (
	...
	"github.com/gsyiven/truss/gengokit"
	templateFileAssets "github.com/gsyiven/truss/gengokit/template"
	"github.com/gsyiven/truss/svcdef"

	"github.com/gsyiven/truss/gengokit/gentesthelper"
)
...
func TestApplyTemplateFromPath(t *testing.T) {
	const def = `
		...
		import "github.com/gsyiven/truss/deftree/googlethirdparty/annotations.proto";
	...
	conf := gengokit.Config{
		GoPackage: "github.com/gsyiven/truss",
		PBGoPackage: "github.com/gsyiven/truss/gengokit/general-service",
	}
...
func TestAllTemplates(t *testing.T) {
	const goPackage = "github.com/gsyiven/truss/gengokit"
	const goPBPackage = "github.com/gsyiven/truss/gengokit/general-service"
	...
	conf := gengokit.Config{
		GoPackage: "github.com/gsyiven/truss/gengokit",
		PBGoPackage: "github.com/gsyiven/truss/gengokit/general-service",
	}
