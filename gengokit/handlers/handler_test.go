...
import (
	...
	helper "github.com/gsyiven/truss/gengokit/gentesthelper"
...
func TestApplyServerTempl(t *testing.T) {
	...
	conf := gengokit.Config{
		GoPackage: "github.com/gsyiven/truss/gengokit/general-service",
	...
	expected := `
		...
		import (
			...
			pb "github.com/gsyiven/truss/gengokit/general-service"
		)
