# Truss [![Build Status](https://travis-ci.org/gsyiven/truss.svg?branch=master)](https://travis-ci.org/gsyiven/truss)
...
1. Install Truss with
	...
	```
	go get -u -d github.com/gsyiven/truss
	cd $GOPATH/src/github.com/gsyiven/truss
	make dependencies
	make
	```
