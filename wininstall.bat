...
go generate github.com/gsyiven/truss/gengokit/template
go install -ldflags "-X 'main.Version=%SHA%' -X 'main.VersionDate=%HEAD_DATE%'" github.com/gsyiven/truss/cmd/truss
@ECHO OFF